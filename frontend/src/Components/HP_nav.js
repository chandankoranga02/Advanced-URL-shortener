...
export default function HP_nav({ user, status_log }) {
      ...
      <header className="bg-zinc-950 border-b border-zinc-800 w-full">
        <div className="w-full px-10 h-[60px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <button onClick={() => { navigate("/home") }} className="bg-red-500 hover:bg-red-400 text-zinc-950 font-mono text-sm font-semibold px-4 py-1.5 rounded cursor-pointer transition-colors">
              Logout
            </button>
